...
public class Main {
    public static void main(String[] args) {
        ...
        FootballPlayer footballPlayer = new FootballPlayer("Alessandro", "Greco", "alegreco@gmail.com", "alegreco");
        SportCenter center = new SportCenter("Sport Village", "Rome", "via Oceano Pacifico", "manager@gmail.com", "image.png", 40f);
        Booking booking = new Booking(center, footballPlayer, LocalDate.now(), "17");
