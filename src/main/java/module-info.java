module com.example.connect5_project {
    ...
    exports com.example.connect5_project.take_booking.model.bookings_type_decorator;
    ...
    opens com.example.connect5_project.take_booking.model.bookings_type_decorator to javafx.fxml;
